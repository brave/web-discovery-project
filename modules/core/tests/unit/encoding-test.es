...
const utf8 = new Uint8Array([
  229, 155, 155, 229, 183, 157, 232, 143, 156, 229, 165, 189, 232, 190, 163,
  229, 149, 138,
]);
  ...
  () => {
    describe("Encoding tests", function () {
      it("base64", function () {
        ...
        chai
          .expect(arrayEquals(this.module().fromBase64(b641), bin1))
          .to.equal(true);
        chai
          .expect(arrayEquals(this.module().fromBase64(b642), bin2))
          .to.equal(true);
        chai
          .expect(arrayEquals(this.module().fromBase64(b643), bin3))
          .to.equal(true);
      });
      ...
      it("hex", function () {
        ...
        chai
          .expect(arrayEquals(this.module().fromHex(h641), bin1))
          .to.equal(true);
        chai
          .expect(arrayEquals(this.module().fromHex(h642), bin2))
          .to.equal(true);
        chai
          .expect(arrayEquals(this.module().fromHex(h643), bin3))
          .to.equal(true);
      });
