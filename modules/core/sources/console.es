...
export function enable() {
  _console.debug = console.log.bind(console, "[wdp] [debug]");
  _console.log = console.log.bind(console, "[wdp]");
  _console.error = console.error.bind(console, "[wdp] [error]");
  _console.warn = console.warn.bind(console, "[wdp] [warning]");
