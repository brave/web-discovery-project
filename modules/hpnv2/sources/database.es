...
export default class Database {
  ...
  async setUserPK(value) {
    ...
    this.userPK = value;
    return this.db
      ? this.db.meta.put({ key: "userPK", value })
      : Promise.resolve();
  }
  ...
  async setGroupPubKey(
    ...
    return this.db
      ? this.db.meta.put({ key: "groupPubKeys", value: this.groupPubKeys })
      : Promise.resolve();
  }
  ...
  async setSourceMapAction(action, value) {
    ...
    return this.db
      ? this.db.meta.put({ key: "sourceMap", value: this.sourceMap })
      : Promise.resolve();
  }
  ...
  async init() {
    ...
    try {
      ...
      this.groupPubKeys =
        (groupPubKeys && groupPubKeys.value) || this.groupPubKeys;
  ...
  async purgeTags(currentHours) {
    ...
    return this.db
      ? this.db.tags.where("expireat").below(currentHours).delete()
      : Promise.resolve();
  }
}
