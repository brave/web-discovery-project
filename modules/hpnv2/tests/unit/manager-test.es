...
export default describeModule(
  ...
  () => {
    describe("#Manager", () => {
      ...
      describe("#checkGroupPublicKeys", () => {
        ...
        it("should pass if none of the keys changed", function () {
          ...
          expect(Manager.checkGroupPublicKeys(newKeys, newKeys, oldKeys)).to.be
            .true;
        });
        ...
        it("should fail if ecdh do not match group pub keys dates", function () {
          ...
          expect(Manager.checkGroupPublicKeys(newKeys, newKeys2, oldKeys)).to.be
            .false;
          expect(Manager.checkGroupPublicKeys(newKeys, newKeys3, oldKeys)).to.be
            .false;
        });
    ...
    describe("#InitState", () => {
      ...
      it.skip("should support staying in destroyed state", function () {
        uut.updateState(InitState.DESTROYED);
        uut.updateState(InitState.DESTROYED);
      });
