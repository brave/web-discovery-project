...
function createFakeConfig(ts, { sourceMapVersion = 0 } = {}) {
  const DUMMY_GROUP_PUB_KEY =
    "";
  const DUMMY_PUB_KEY =
    "BNA4mKegSpi1CMU4Y1AsaxUWfzwvtnBaoUbucfqdQvFwDFpoZk/26lEvPXDYiBLAGY7Jvj1mFsW4wVV0oDTHZ/o=";
      ...
      describe("when simulating updates over multiple days", function () {
        ...
        const impl = async ({
          ...
          while (new Date() - start <= totalDurationInMs) {
            ...
            if (
              sourceMapChangeFrequencyInMin > 0 &&
              minutesElapsed >= nextSourceMapChange
            ) {
              ...
              nextSourceMapChange =
                (1 + Math.floor(minutesElapsed / freq)) * freq;
            }
          ...
          if (networkErrorRate < 1.0) {
            ...
            const minExpectedChanges =
              0.95 * daysSeen +
              0.7 * sourceMapChanges * (1 - networkErrorRate) -
              changeTolerance;
            ...
            const minExpectedRequests =
              0.8 * (totalDurationInMs / uut.loadConfigSuccessMaxInterval) -
              requestTolerance;
            const maxExpectedRequests =
              (totalDurationInMs / uut.loadConfigSuccessMinInterval + 1) *
              (1 / networkErrorRate);
