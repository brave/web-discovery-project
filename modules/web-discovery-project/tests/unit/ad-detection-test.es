...
export default describeModule(
  "web-discovery-project/ad-detection",
  () => ({}),
  () => {
    ...
    describe("normalizeAclkUrl", function () {
      ...
      it('should consider ads to be identical if only their "ved" code differs', function () {
        const sharedPrefix =
          "https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjyu42VwLPWAhUQnhsKHYgzAZcYABAJGgJ3bA&ohost=www.google.de&cid=CAASEuRopco2XerPuHClGWTnWaddQg&sig=AOD64_36ojDsT8n10T9Xg6jpqqFpeAlvWQ&ctype=5&q=";
      ...
      it('should ignore "adurl" and "q" parameters', function () {
        const url1 =
          "https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjJt6z20PrWAhUiKNMKHfvTB4kYABAAGgJ3Yg&ohost=www.google.de&cid=CAASEuRobxFBtt0g1nfQpKP2P2hE6Q&sig=AOD64_0B3ktCajIy1rkz-mH2AO8PDPAmug&adurl=&q=";
        const url2 =
          "https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjJt6z20PrWAhUiKNMKHfvTB4kYABAAGgJ3Yg&ohost=www.google.de&cid=CAASEuRobxFBtt0g1nfQpKP2P2hE6Q&sig=AOD64_0B3ktCajIy1rkz-mH2AO8PDPAmug&q=&adurl=";
      ...
      it('should not rely on the order of "adurl" and "q" parameters', function () {
        const url1 =
          "https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjo8OmgzPrWAhXuCtMKHQbaAt0YABAAGgJ3Yg&ohost=www.google.de&cid=CAASEuRovOsq8jYWW7VzZbLgEFV4vw&sig=AOD64_2K3umt-jl0hvOZeZXWExyyAWAfjw&q=&ved=0ahUKEwjareagzPrWAhVBvhQKHeCCDzEQ0QwIZA&adurl=";
        const url2 =
          "https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjo8OmgzPrWAhXuCtMKHQbaAt0YABAAGgJ3Yg&ohost=www.google.de&cid=CAASEuRovOsq8jYWW7VzZbLgEFV4vw&sig=AOD64_2K3umt-jl0hvOZeZXWExyyAWAfjw&adurl=&ved=0ahUKEwjareagzPrWAhVBvhQKHeCCDzEQ0QwIZA&q=";
      ...
      it('should consider ads to be identical if only the first part of the URL (before "aclk") differs', () => {
        ...
        const sharedSuffix =
          "/aclk?sa=L&ai=DChcSEwjyu42VwLPWAhUQnhsKHYgzAZcYABAJGgJ3bA&ohost=www.google.de&cid=CAASEuRopco2XerPuHClGWTnWaddQg&sig=AOD64_36ojDsT8n10T9Xg6jpqqFpeAlvWQ&ctype=5&q=";
