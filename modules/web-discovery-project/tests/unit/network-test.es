...
export default describeModule(
  ...
  () => {
    ...
    describe("parseURL", function () {
      ...
      // web-discovery-project relies on the assumption that URLs
    ...
    describe("#Network", function () {
      ...
      it("should pass without changing the message if all domains are public", async function () {
        ...
        await expect(uut.sanitizeUrlsWithPrivateDomains(msg))
          .to.eventually.exist // == message not dropped
