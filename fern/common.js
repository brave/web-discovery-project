...
function setConfigPath(configPath, buildIntoSubdir) {
  const _configPath = configPath || process.env.CONFIG_PATH;
  process.env.CONFIG_PATH = _configPath;
...
const configParameter = process.env.CONFIG_PATH
  ? "[configFile]"
  : "<configFile>";
