...
DOCKER_RUN="docker run --rm -t --user node -p 15900:5900 -v $(pwd)/modules:/app/modules -v $(pwd)/platforms:/app/platforms $EXTLOG_MOUNT -w /app docker-wdp-tests ./tests/run_tests.sh $FERN_ARGS"
